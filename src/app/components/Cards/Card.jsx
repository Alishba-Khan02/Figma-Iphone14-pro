...
if (check) {
  ...
  return ( 
    ...
    <div className="w-[100%] h-7 flex justify-end p-4 hover"  onClick={changeColor}>{heartIcon}</div>
    <div className="flex justify-center items-center mt-12"><Image src={props.pic} className="w-56 product" alt="Picture of the product"/></div>
    ...
    <div className="w-[100%] mt-7 buy-btn flex justify-center items-center">
      <button className="hover hover-card-btn">Buy Now</button>
    </div>
    </div>
  )
