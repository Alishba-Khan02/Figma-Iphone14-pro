...
const SecondCard = (props) => {
  return (
    ...
    <div className="w-[100%] overflow-hidden h-[25rem] flex justify-center items-center"  ><Image src={props.pic} className="w-[25rem] mt-20 overflow-hidden" alt="Picture o"/></div>
